...
from transformers.utils import is_liger_kernel_available, logging
...
def apply_liger_kernel(model, kernel_config):
    ...
    from lightning_grpo.utils.liger_kernel.monkey_patch import _apply_liger_kernel_to_instance
