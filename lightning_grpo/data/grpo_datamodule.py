...
from lightning_grpo.utils.configs.grpo import GRPORolloutConfig
...
class GRPORolloutCollator:
    ...
    def __init__(self, tokenizer: PreTrainedTokenizerBase, rollout_config: GRPORolloutConfig) -> None:
...
class GRPODataModule(ChatTemplateDataModule):
    ...
    def __init__(
        ...
        rollout_config: GRPORolloutConfig,
